...
void allocate_array(int c[], t_array** t01_array, t_array** t02_array, t_array** t10_array, t_array** t12_array, t_array** t20_array, t_array** t21_array) {
	...
	// 4				201.29
	// --------------------------------
	*t01_array = (t_array*)malloc(sizeof(t_array) * c[0]);
	*t02_array = (t_array*)malloc(sizeof(t_array) * c[0]);
	*t10_array = (t_array*)malloc(sizeof(t_array) * c[1]);
	*t12_array = (t_array*)malloc(sizeof(t_array) * c[1]);
	*t20_array = (t_array*)malloc(sizeof(t_array) * c[2]);
	*t21_array = (t_array*)malloc(sizeof(t_array) * c[2]);
}
...
void processing(int process, int c[], student* ps,
	...
	case 0:
		...
		allocate_pointer(t01_array, t02_array, t10_array, t12_array, t20_array, t21_array, &pt01, &pt02, &pt10, &pt12, &pt20, &pt21);
		printf("pt10 = %d\n", pt10);
		...
		printf("pt10 = %d\n", pt10);
		free_array(&t01_array, &t02_array, &t10_array, &t12_array, &t20_array, &t21_array, &pt01, &pt02, &pt10, &pt12, &pt20, &pt21);
		break;
	case 1:
		allocate_array(&c[0], &t01_array, &t02_array, &t10_array, &t12_array, &t20_array, &t21_array);
		allocate_pointer(t01_array, t02_array, t10_array, t12_array, t20_array, t21_array, &pt01, &pt02, &pt10, &pt12, &pt20, &pt21);
...
void run_contest(void)
{
	...
	student s[10000];
	student* ps = &s[0];
	t_array* t01_array = NULL, * t02_array = NULL, * t10_array = NULL, * t12_array = NULL, * t20_array = NULL, * t21_array = NULL;
	t_array* pt01 = NULL, * pt02 = NULL, * pt10 = NULL, * pt12 = NULL, * pt20 = NULL, * pt21 = NULL;
