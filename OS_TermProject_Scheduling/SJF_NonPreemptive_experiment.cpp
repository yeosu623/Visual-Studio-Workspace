...
int SJF_NonPreemptive_experiment::random_int(int min, int max) {
	random_device dev;
	mt19937 seed(dev());
...
SJF_NonPreemptive_experiment::SJF_NonPreemptive_experiment() {
	system("cls");
...
void SJF_NonPreemptive_experiment::sort_process() {
	for (int i = 0; i < n - 1; i++)
		for (int j = i + 1; j < n; j++)
...
void SJF_NonPreemptive_experiment::sort_result() {
	for (int i = 0; i < n - 1; i++)
		for (int j = i + 1; j < n; j++)
...
void SJF_NonPreemptive_experiment::sort_wait() {
...
void SJF_NonPreemptive_experiment::insert() {
...
void SJF_NonPreemptive_experiment::process() {
	idx_none = 0;
	idx_wait = 0;
	idx_run = EMPTY;
	elapsed_time = 0;
...
void SJF_NonPreemptive_experiment::result() {
